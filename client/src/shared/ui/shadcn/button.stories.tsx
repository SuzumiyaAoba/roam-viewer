...
const meta: Meta<typeof Button> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A versatile button component built with Tailwind CSS and class-variance-authority. Supports multiple variants, sizes, and can render as different elements using the asChild prop.',
      },
    },
  },
  tags: ['autodocs'],
