...
const meta: Meta<typeof Badge> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A versatile badge component for displaying status, categories, or other metadata. Supports multiple variants and sizes.',
      },
    },
  },
  tags: ['autodocs'],
  ...
  render: () => (
    <div className="flex flex-wrap gap-4 items-center">
      ...
      <div className="relative">
        ...
        <Badge variant="destructive" className="absolute -top-2 -right-2">12</Badge>
      </div>
      ...
      <div className="relative">
        ...
        <Badge variant="secondary" className="absolute -top-2 -right-2">99+</Badge>
      </div>
    </div>
  ),
}
