...
const EmptyStateNoResults = forwardRef<HTMLDivElement, Omit<EmptyStateProps, 'icon' | 'title' | 'description'> & {
  searchQuery?: string
...
const EmptyStateNoNodes = forwardRef<HTMLDivElement, Omit<EmptyStateProps, 'icon' | 'title' | 'description'>>(
  (props, ref) => (
    <EmptyState
      ref={ref}
      icon="📝"
...
const EmptyStateError = forwardRef<HTMLDivElement, Omit<EmptyStateProps, 'icon' | 'title'> & {
  error?: string
}>(({ error, ...props }, ref) => (
  <EmptyState
    ref={ref}
...
const EmptyStateLoading = forwardRef<HTMLDivElement, Omit<EmptyStateProps, 'icon' | 'title' | 'description'>>(
  (props, ref) => (
    <EmptyState
      ref={ref}
      variant="muted"
...
const EmptyStateOffline = forwardRef<HTMLDivElement, Omit<EmptyStateProps, 'icon' | 'title' | 'description'>>(
  (props, ref) => (
    <EmptyState
      ref={ref}
      icon={
        <svg className="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M18.364 5.636l-12.728 12.728m0 0L12 12m-6.364 6.364L12 12m6.364-6.364L12 12" />
        </svg>
      }
