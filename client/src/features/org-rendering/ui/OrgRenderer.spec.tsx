  ...
  describe("Basic text rendering", () => {
    it("should render simple paragraphs", () => {
      ...
      expect(container.innerHTML).toContain(
        '<p class="text-gray-700 leading-relaxed mb-4">This is a simple paragraph.</p>',
      );
    });
...
Second paragraph.`;
  ...
  describe("Headers", () => {
    it("should render level 1 headers", () => {
      ...
      expect(container.innerHTML).toContain(
        '<h1 class="text-3xl font-bold text-gray-900 mb-4 mt-8 first:mt-0">Main Header</h1>',
      );
    });
    ...
    it("should render level 2 headers", () => {
      ...
      expect(container.innerHTML).toContain(
        '<h2 class="text-2xl font-semibold text-gray-800 mb-3 mt-6">Sub Header</h2>',
      );
    });
    ...
    it("should render level 3 headers", () => {
      ...
      expect(container.innerHTML).toContain(
        '<h3 class="text-xl font-semibold text-gray-800 mb-3 mt-5">Sub Sub Header</h3>',
      );
    });
    ...
    it("should handle headers with inline formatting", () => {
      ...
      expect(container.innerHTML).toContain(
        '<strong class="font-semibold text-gray-900">Bold</strong>',
      );
...
- =Code= item`;
      ...
      expect(container.innerHTML).toContain('<em class="italic">Italic</em>');
      expect(container.innerHTML).toContain(
        '<code class="bg-gray-100 text-gray-800 px-1.5 py-0.5 rounded text-sm font-mono">Code</code>',
      );
    });
  });
...
#+END_SRC`;
      ...
      expect(container.innerHTML).toContain(
        '<pre class="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto mb-4 text-sm">',
      );
...
#+END_SRC`;
  ...
  describe("Inline formatting", () => {
    ...
    it("should render strikethrough text", () => {
      ...
      expect(container.innerHTML).toContain(
        '<del class="line-through text-gray-500">strikethrough</del>',
      );
    });
  ...
  describe("Links", () => {
    it("should render simple links", () => {
      ...
      expect(container.innerHTML).toContain(
        '<a href="https://example.com" class="text-blue-600 hover:text-blue-800 underline" target="_blank" rel="noopener noreferrer">https://example.com</a>',
      );
    });
    ...
    it("should render links with descriptions", () => {
      ...
      expect(container.innerHTML).toContain(
        '<a href="https://example.com" class="text-blue-600 hover:text-blue-800 underline" target="_blank" rel="noopener noreferrer">Example Website</a>',
      );
    });
    ...
    it('should render internal links without target="_blank"', () => {
      ...
      expect(container.innerHTML).toContain(
        '<a href="internal-page" class="text-blue-600 hover:text-blue-800 underline">internal-page</a>',
      );
